...
if __name__ == "__main__": #the library owner says this is necessary to avoid collapse in Windows
    ...
    myMagstim = magstim.Rapid(serialConnection='COM20', superRapid=1, unlockCode='the 4-8-2 digit code comes with the stimulator') #magstim initialization: you need to configure this part with your own serial port and stimulator.
